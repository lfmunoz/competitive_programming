...
00524:
	--mkdir -p target/classes
	@echo "Runnning UVA00524"
	javac $(SRC)/UVa00524.java -d $(TARGET)
	java -cp $(TARGET) uva00524.Main < $(RSRC)/uva00524_in.txt | diff -s -y $(RSRC)/uva00524_out.txt -

#######################################################
00574:
	--mkdir -p target/classes
	@echo "Runnning UVA00574"
	javac $(SRC)/UVa00574.java -d $(TARGET)
	java -cp $(TARGET) uva00574.Main < $(RSRC)/uva00574_in.txt | diff -s -y $(RSRC)/uva00574_out.txt -
...
10656:
	--mkdir -p target/classes
	@echo "Runnning UVA10656"
	javac $(SRC)/UVa10656.java -d $(TARGET)
	java -cp $(TARGET) uva10656.Main < $(RSRC)/uva10656_in.txt | diff -s -y $(RSRC)/uva10656_out.txt -

#######################################################
10718:
	--mkdir -p target/classes
	@echo "Runnning UVA10718"
	javac $(SRC)/UVa10718.java -d $(TARGET)
	java -cp $(TARGET) uva10718.Main < $(RSRC)/uva10718_in.txt | diff -s -y $(RSRC)/uva10718_out.txt -
